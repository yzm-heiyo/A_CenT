...
public class TransHomeModel implements ITransHomeModel {


    private static TransHomeModel homeModel = new TransHomeModel();

    public static synchronized TransHomeModel getInstance() {
        return homeModel;
    }
                    ...
                    switch (address) {
                        case HttpUtil.URL_FAST_SEARCH:
                            try {
                                ...
                                AppNetViewDataManager.setTranTagList(searchResponse.getPropertyFastSearcherTags());
