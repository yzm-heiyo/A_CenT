...
public class Parameter implements Serializable {
    ...
    public Parameter(String systemParamNewUpdateTime, boolean needUpdate, List<com.centanet.hk.aplus.bean.params.SystemParam> systemParam, boolean flag, String errorMsg, String runTime) {
    ...
    public void setSystemParam(List<com.centanet.hk.aplus.bean.params.SystemParam> systemParam) {
        SystemParam = systemParam;
    }
    ...
    public List<com.centanet.hk.aplus.bean.params.SystemParam> getSystemParam() {
        return SystemParam;
    }
