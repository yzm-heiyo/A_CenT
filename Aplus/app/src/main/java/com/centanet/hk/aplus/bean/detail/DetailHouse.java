...
public class DetailHouse implements Serializable {
    ...
    public boolean isUserIsShowTrustor() {
        return UserIsShowTrustor;
    }
    ...
    public void setUserIsShowTrustor(boolean userIsShowTrustor) {
        UserIsShowTrustor = userIsShowTrustor;
    }
