...
public class WheelViewDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void initView() {
        ...
        dialog.setContentView(R.layout.item_wheelview);
        ...
        wheelViewTo.setAdapter(new ArrayWheelAdapter(yearList));
        wheelViewTo.setOnItemSelectedListener(new OnItemSelectedListener() {
            @Override
            public void onItemSelected(int index) {
                years[1] = yearList.get(index);
            }
        });
