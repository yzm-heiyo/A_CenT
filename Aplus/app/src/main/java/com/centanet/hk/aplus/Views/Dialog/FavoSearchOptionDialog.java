...
public class FavoSearchOptionDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void initLisenter() {
        ...
        paramsManager = FavoRequestParamsManager.getParams();
...
//        paramsManager.get
    ...
    public void initData(HouseDescription description) {
        ...
        PropertyRequestSaveParams paramsManager = FavoRequestParamsManager.getParams();
        ...
        List<TagInfo> tagInfos = FavoRequestParamsManager.getParams().getTagInfos();
