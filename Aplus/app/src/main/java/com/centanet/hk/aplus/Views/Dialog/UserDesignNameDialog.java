...
public class UserDesignNameDialog extends DialogFragment implements View.OnClickListener {
    ...
    public UserDesignNameDialog() {
    }

    @SuppressLint("ValidFragment")
    public UserDesignNameDialog(View view, double dialogWidthPercent, double dialogHeightPercent) {
        this.view = view;
    ...
    @SuppressLint("ValidFragment")
    public UserDesignNameDialog(View view, double dialogWidthPercent, double dialogHeightPercent, int layout_ID) {
        this.view = view;
        this.dialogWidthPercent = dialogWidthPercent;
        this.dialogHeightPercent = dialogHeightPercent;
...
//        getDialog().getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        ...
        View content = inflater.inflate(R.layout.dialog_sava_userdesign, container, false);
        ...
        editText = content.findViewById(R.id.dialog_edit_name);
...
//            content.measure(0,0);
        ...
        switch (v.getId()) {
            case R.id.tips_dialog_left:
                ...
                if (mOnItemClickListener != null)
                    mOnItemClickListener.onClick(this, null, DIALOG_CANCEL);
                break;
            case R.id.tips_dialog_right:
                dismiss();
                if (mOnItemClickListener != null)
                    mOnItemClickListener.onClick(this, editText.getText().toString(), DIALOG_YES);
                break;
        }
    }
    ...
    public interface OnItemClickListener {
        void onClick(DialogFragment dialog, String s, int type);
    }
