...
public class SearchFragment extends BaseFragment implements ISearchView, View.OnClickListener, VoiceInputPanel.EventListener, FragmentBackHandler {
...
//                        }
            ...
            case R.id.search_txt_area:
                ...
                areaDialog.setItem(ApplicationManager.getDistrictItems(), houseDescription.getDistrictListIds());
            ...
            case R.id.search_ll_floot:
                ...
                strs[0] = houseDescription.getFloors();
                strs[1] = houseDescription.getUnits();
                ...
                dialog.setOnItemClickLisenter((dialog1, v1, list) -> {
                    ...
                    houseDescription.setFloors(list[0]);
                    houseDescription.setUnits(list[1]);
...
//        ft.addToBackStack(null);
        Fragment fragment = getParentFragment().getChildFragmentManager().findFragmentByTag(HouseFragment.FRAGMENT_TAG_HOUSELIST);
        if (fragment != null) {
            ft.show(fragment);
            ft.hide(this).commit();
        } else {
