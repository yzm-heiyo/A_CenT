...
public class DateDemoFragment extends Fragment implements View.OnClickListener{
    ...
    private DateFragment.OnDateChangeLisenter onDateChangeLisenter;
    public static String ARGUMENT = "SysItemFragment";

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        if (context instanceof DateFragment.OnDateChangeLisenter) {
            onDateChangeLisenter = (DateFragment.OnDateChangeLisenter) context;
        } else
    ...
    public void openDate() {
        ...
        openDataDialog.setOnDialogClikeLisenter((dialog, viewId, result) -> {
            ...
            if ((dateFrom == null || dateFrom.equals("") && (dateTo == null || dateTo.equals("")))) {
                ...
                houseDescription.setPropertyDateTo((Calendar.YEAR) + "-" + calendar.get(Calendar.MONTH) + "-" + calendar.get(Calendar.DAY_OF_MONTH));

                calendar.add(Calendar.MONTH, -1);
                String dateStar = calendar.get(Calendar.YEAR) + "年" + calendar.get(Calendar.MONTH) + "月" + calendar.get(Calendar.DAY_OF_MONTH) + "日";
                houseDescription.setPropertyDateFrom((Calendar.YEAR) + "-" + calendar.get(Calendar.MONTH) + "-" + calendar.get(Calendar.DAY_OF_MONTH));
...
//
        ...
        Calendar calendar = Calendar.getInstance();
        L.d("changeToCalendar_YEAR",dates[0]);
        L.d("changeToCalendar_MONTH",dates[1]);
        L.d("changeToCalendar_DAY",dates[2]);
