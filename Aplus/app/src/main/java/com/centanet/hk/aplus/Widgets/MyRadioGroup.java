...
/**
 * Created by mzh1608258 on 2017/7/24.
 */
...
public class MyRadioGroup extends LinearLayout {
    ...
    private HashMap<Integer, RadioButton> mRadioButtons = new HashMap<Integer, RadioButton>();
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public ArrayList<RadioButton> findRadioButtons(ViewGroup vg) {
            ArrayList<RadioButton> set = new ArrayList<RadioButton>();
